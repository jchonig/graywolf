...
export interface paths {
    ...
    "/map-routes": {
        ...
        /** List map routes */
        get: operations["listMapRoutes"];
        put?: never;
        /** Create map route */
        post: operations["createMapRoute"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/map-routes/{id}": {
        ...
        /** Get map route */
        get: operations["getMapRoute"];
        /** Update map route */
        put: operations["updateMapRoute"];
        post?: never;
        /** Delete map route */
        delete: operations["deleteMapRoute"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export interface components {
    ...
    requestBodies: {
        ...
        "dto.MapRouteRequest": {
            content: {
                "application/json": components["schemas"]["dto.MapRouteRequest"];
            };
        };
...
export interface operations {
    ...
    listMapRoutes: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["dto.MapRouteResponse"][];
                };
            };
            /** @description Internal Server Error */
            500: {
    ...
    createMapRoute: {
        ...
        requestBody: components["requestBodies"]["dto.MapRouteRequest"];
        responses: {
            /** @description Created */
            201: {
                headers: {
